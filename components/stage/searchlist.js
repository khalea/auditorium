                        ...
                        <div key={item.id.videoId} className="flex flex-row py-1 space-x-2">
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="flex flex-row space-x-2 pt-2">
                                    <button onClick={() => handleQueueAdd(item)} className="w-auto h-auto">
...
onClick take element from props.data & return it to the parent (SearchList -> SearchContainer -> Stage)
-> Stage: Pass addToQueue function into SearchContainer
-> SearchContainer: Pass addToQueue function into SearchList
-> SearchList: onClick, use addToQueue to modify the queue data
*/